...
external pages examples cli s

npx untitledui@latest add qr-code
npx untitledui@latest add button-utility
npx untitledui@latest add input

there is a delay for redirect request for mforntend only like show 321 autoamtic redirects whenevr soemcomes on our own short url 
we can use this aniamtion here is code 
43<div class='tetrominos'>
...
this loading can be for login singup creatin url saving overall website animation 
here is code 
